    ...
    public class GamingCornerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Console_>().HasData(
                new Console_ { ConsoleId = 1, Name = "Play Station 4", Specifications = "CPU:AMD 'Jaguar' x86-64, 8 núcleos; GPU: motor gráfico AMD de 1,84 TFLOPS basado en Radeon; Memoria:8 GB GDDR5; Almacenamiento:1 TB; Peso: Aprox. 2,1 Kg; Entrada/Salida:2 puertos de altísima velocidad USB (USB 3.1 Gen1) y 1 puerto AUX; Red:1 puerto Ethernet (10BASE-T, 100BASE-TX, 1000BASE-T) / IEEE 802.11 a/b/g/n/ac / Bluetooth® 4.0; Alimentacion:AC de 100-240 V, 50/60 Hz; Consumo de energia: 165W; Salida AV:Salida HDMI™ (compatible con salida HDR)", Price = 300, Stock = 16, Available = true, ImageURL = "https://gmedia.playstation.com/is/image/SIEPDC/ps4-pro-product-thumbnail-01-en-14sep21", PlatformId = 1 },
                new Console_ { ConsoleId = 2, Name = "Play Station 5", Specifications = "CPU: AMD Ryzen Zen 2, 8 núcleos a 3.5GHz; GPU: AMD RDNA 2, 10.28 TFLOPs, 36 CUs a 2.23GHz; Memoria: 16 GB GDDR6; Almacenamiento: SSD personalizado de 825 GB; Peso: Aprox. 4.5 Kg; Entrada/Salida: 2 puertos USB de alta velocidad (USB 3.1 Gen2), 1 puerto USB-C; Red: 1 puerto Ethernet (10BASE-T, 100BASE-TX, 1000BASE-T), Wi-Fi 6 (802.11ax), Bluetooth® 5.1; Alimentación: AC 100-240V, 50/60Hz; Consumo de energía: 350W; Salida AV: Salida HDMI™ 2.1 (compatible con 4K a 120Hz, 8K, y HDR)", Price = 490, Stock = 16, Available = true, ImageURL = "https://m.media-amazon.com/images/I/51f6iZlNnvL.jpg", PlatformId = 1 },
                new Console_ { ConsoleId = 3, Name = "Xbox 360", Specifications = "CPU: IBM PowerPC Tri-Core Xenon a 3.2GHz; GPU: ATI Xenos, 240 GFLOPs; Memoria: 512 MB GDDR3 a 700 MHz; Almacenamiento: Disco duro de 20 GB/60 GB/120 GB (según modelo); Peso: Aprox. 3.5 Kg; Entrada/Salida: 3 puertos USB 2.0; Red: 1 puerto Ethernet (10/100), Wi-Fi opcional con adaptador externo (en modelos antiguos); Alimentación: AC 100-240V, 50/60Hz; Consumo de energía: Aprox. 175W; Salida AV: Salida HDMI™, Salida por componentes, Salida por cable AV estándar", Price = 265, Stock = 5, Available = true, ImageURL = "https://i.ebayimg.com/images/g/oBUAAOSwVgljSZS8/s-l400.jpg", PlatformId = 3 },
                new Console_ { ConsoleId = 4, Name = "Xbox Series X", Specifications = "CPU: AMD Ryzen Zen 2, 8 núcleos a 3.8GHz (3.6GHz con SMT); GPU: AMD RDNA 2, 12 TFLOPs, 52 CUs a 1.825GHz; Memoria: 16 GB GDDR6; Almacenamiento: SSD NVMe personalizado de 1 TB; Peso: Aprox. 4.45 Kg; Entrada/Salida: 3 puertos USB 3.1 Gen1; Red: 1 puerto Ethernet (10/100/1000), Wi-Fi 5 (802.11ac), Bluetooth®; Alimentación: AC 100-240V, 50/60Hz; Consumo de energía: Aprox. 315W; Salida AV: Salida HDMI™ 2.1 (compatible con 4K a 120Hz, 8K, y HDR)", Price = 500, Stock = 8, Available = true, ImageURL = "https://m.media-amazon.com/images/I/61nq7mC0tHL._AC_UF894,1000_QL80_.jpg", PlatformId = 3 },
                new Console_ { ConsoleId = 5, Name = "Nintendo Switch", Specifications = "CPU: NVIDIA Custom Tegra Processor; GPU: NVIDIA GPU basada en arquitectura Maxwell; Memoria: 4 GB LPDDR4; Almacenamiento: 32 GB de almacenamiento interno (expandible mediante tarjeta microSD hasta 2 TB); Peso: Aprox. 0.88 Kg (con Joy-Con); Entrada/Salida: 1 puerto USB Type-C (para carga), 1 puerto para cartuchos de juego, ranura para tarjeta microSD; Red: Wi-Fi 802.11 a/b/g/n/ac, Bluetooth® 4.1, Soporte LAN con adaptador (vía base de acoplamiento); Alimentación: Batería interna de ion de litio de 4310mAh, cargador AC 100-240V; Consumo de energía: Aprox. 18W (en modo portátil); Salida AV: Salida HDMI™ (modo TV, hasta 1080p), pantalla de 6.2 pulgadas LCD (1280x720 en modo portátil)", Price = 280, Stock = 6, Available = true, ImageURL = "https://img.pccomponentes.com/articles/23/233482/consola-nintendo-switch-1351124-81-l.jpg", PlatformId = 4 },
                new Console_ { ConsoleId = 6, Name = "Nintendo Switch Lite", Specifications = "CPU: NVIDIA Custom Tegra Processor; GPU: NVIDIA GPU basada en arquitectura Maxwell; Memoria: 4 GB LPDDR4; Almacenamiento: 32 GB de almacenamiento interno (expandible mediante tarjeta microSD hasta 2 TB); Peso: Aprox. 0.275 Kg; Entrada/Salida: 1 puerto USB Type-C (para carga), 1 puerto para cartuchos de juego, ranura para tarjeta microSD; Red: Wi-Fi 802.11 a/b/g/n/ac, Bluetooth® 4.1; Alimentación: Batería interna de ion de litio de 3570mAh, cargador AC 100-240V; Consumo de energía: Aprox. 13.5W (en modo portátil); Salida AV: Pantalla de 5.5 pulgadas LCD (1280x720), sin salida HDMI (solo modo portátil)", Price = 160, Stock = 10, Available = true, ImageURL = "https://img.pccomponentes.com/articles/22/224445/1.jpg", PlatformId = 4 }
            );
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { ProductId = 1, Name = "COD nuevo", Description = "COD Infinite Warfare nuevo en perfectas condiciones y con su precinto", Price = 15, Available = true, ImageURL = "https://cdn.wallapop.com/images/10420/g2/d9/__/c10420p971437424/i4694537666.jpg?pictureSize=W640" },
                new Product { ProductId = 2, Name = "Uncharted", Description = "Juego casi nuevo", Price = 10, Available = true, ImageURL = "https://secondbest.es/wp-content/uploads/2024/08/Photoroom-20240823_175759_1.webp" },
