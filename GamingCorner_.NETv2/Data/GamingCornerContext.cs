...
namespace GamingCorner.Data
{
    public class GamingCornerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    new SecondHandProduct { ProductId = 2, Name = "Uncharted", Description = "Juego casi nuevo", Price = 10, Available = true, ImageURL = "https://secondbest.es/wp-content/uploads/2024/08/Photoroom-20240823_175759_1.webp" },
            //    new SecondHandProduct { ProductId = 3, Name = "Dark Souls", Description = "Practicamente nuevo", Price = 7, Available = true, ImageURL = "https://images.milanuncios.com/api/v1/ma-ad-media-pro/images/69f02b50-a035-4b00-a96b-184ba7a061d1?rule=hw396_70" }
            //);
