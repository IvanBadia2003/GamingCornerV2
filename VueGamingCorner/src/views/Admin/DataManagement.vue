<template>
  <AddProductDialogComponent :show="dialogAbierto" :type="formType" :initialData="selectedItem" 
    @cancel="dialogAbierto = false" />
  <v-container fluid class="pa-6">
    ...
    <v-window v-model="tab" class="mt-4">
      ...
      <v-window-item value="juegos">
        <v-data-table :headers="gameHeaders" :items="games" class="elevation-1" item-value="id">
          <template #top>
            <v-toolbar flat>
