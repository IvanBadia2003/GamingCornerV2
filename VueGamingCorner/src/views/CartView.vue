...
<template>
    <v-container class="content">
        <v-row class="mt-15">
            ...
            <v-col cols="12" md="7">
                <v-row>
                    <v-col cols="12">
                        ...
                        <h3>CESTA</h3>
                        <v-card class="cart-item pa-4 mb-5" elevation="2" v-for="(item, index) in 3" :key="index">
                            <v-row align="center">
                                <!-- Imagen del producto -->
                                <v-col cols="4">
            ...
            <v-col cols="12" md="5" class="summary-card">
                <h3>RESUMEN</h3>
                ...
                <v-card class=" pa-5 bg-primary" elevation="2">
                    ...
                    <v-row class="mb-3">
                        ...
                        <v-col cols="6" class="text-body-1 text-secondary text-right">50€</v-col>

                        <v-col cols="6" class="text-body-1 text-secondary">Descuento</v-col>
                        <v-col cols="6" class="text-body-1 text-success text-right">-25€</v-col>

                        <v-col cols="6" class="text-h6 font-weight-bold">Subtotal</v-col>
                        <v-col cols="6" class="text-h6 font-weight-bold text-right">3€</v-col>
                    </v-row>

                    <!-- Botón de pago -->
                    <v-btn block class="payment-btn" height="50">
